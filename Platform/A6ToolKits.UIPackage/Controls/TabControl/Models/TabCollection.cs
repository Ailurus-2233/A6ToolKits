...
namespace A6ToolKits.UIPackage.Controls.TabControl.Models;
...
public class TabCollection : ControlBase
{
    ...
    public TabCollection(ObservableCollection<TabItem>? items = null, string? groupName = null)
    {
        ...
        {
            if (s == _groupName && sender is TabItem tabItem) SelectedItem = tabItem;
        };
    ...
    {
        foreach (var item in items) item.GroupName = groupName;
    }
