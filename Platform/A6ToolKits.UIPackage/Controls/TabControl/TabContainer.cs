...
///     页面容器，用于管理多个页面
/// </summary>
public class TabContainer : ControlBase
{
    public static readonly StyledProperty<Dock> TabStripPlacementProperty =
        AvaloniaProperty.Register<TabContainer, Dock>(nameof(TabStripPlacement), Dock.Top);
    ...
    public static readonly StyledProperty<bool> IsHeaderVisibleProperty =
        AvaloniaProperty.Register<TabContainer, bool>(nameof(IsHeaderVisible), true);
    ...
    public static readonly StyledProperty<bool> IsHeaderCloseableProperty =
        AvaloniaProperty.Register<TabContainer, bool>(nameof(IsHeaderCloseable), true);
