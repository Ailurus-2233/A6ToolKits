...
///     工具栏定义类扩展，用于生成工具栏
/// </summary>
public static class ButtonBarDefinitionExtensions
{
    /// <summary>
    ...
    /// </returns>
    public static List<Control> GenerateButtonBar(this IDefinition definition, ButtonBarPosition buttonBarPosition)
    {
